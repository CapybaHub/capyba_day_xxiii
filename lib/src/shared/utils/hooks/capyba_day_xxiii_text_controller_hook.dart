...
CapybaDayXxiiiTextFieldController useCapybaDayXxiiiTextFieldController({
  String? initialValue,
  bool? dirty,
  bool? touched,
...
class _FluterBaseTextControllerHook
    extends Hook<CapybaDayXxiiiTextFieldController> {
  ...
  @override
  HookState<CapybaDayXxiiiTextFieldController, _FluterBaseTextControllerHook>
      createState() => _FluterBaseTextControllerHookState();
}

class _FluterBaseTextControllerHookState extends HookState<
    CapybaDayXxiiiTextFieldController, _FluterBaseTextControllerHook> {
  late CapybaDayXxiiiTextFieldController controller;
  @override
  void initHook() {
    super.initHook();
    controller = CapybaDayXxiiiTextFieldController(
      hook.initialValue,
  ...
  @override
  CapybaDayXxiiiTextFieldController build(BuildContext context) {
    return controller;
  }
}
