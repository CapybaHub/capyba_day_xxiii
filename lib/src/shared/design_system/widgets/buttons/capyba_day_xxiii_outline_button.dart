...
class CapybaDayXxiiiOutlineButton extends StatelessWidget {
  const CapybaDayXxiiiOutlineButton(
    this.text, {
    Key? key,
    this.onPressed,
                  ...
                  child: Row(
                    ...
                    children: [
                      Flexible(
                        child: Text(
                          text ?? '',
                          style: CapybaDayXxiiiTextStyle.button.style,
                ...
                Expanded(
                  ...
                  child: !isLoading
                      ...
                      : const Expanded(
                          flex: 2,
                          child: Center(
                            child: CapybaDayXxiiiCircularProgressIndicator(),
                          ),
                        ),
                ),
              ],
