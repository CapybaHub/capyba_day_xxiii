...
class CapybaDayXxiiiTextFieldController extends TextEditingController {
  List<String? Function(String)> validators;
  void Function(String)? onChanged;
  late BehaviorSubject<CapybaDayXxiiiTextFieldControllerState> _subject;
  ...
  Stream<CapybaDayXxiiiTextFieldControllerState> get stream =>
      _subject.stream.shareReplay(maxSize: 1);
  CapybaDayXxiiiTextFieldController(
    String? value, {
    bool dirty = false,
    bool touched = false,
    ...
    final initialState = CapybaDayXxiiiTextFieldControllerState(
      dirty: dirty,
      touched: touched,
...
@immutable
class CapybaDayXxiiiTextFieldControllerState {
  final bool dirty;
  final bool touched;
  ...
  CapybaDayXxiiiTextFieldControllerState copyWith({
    bool? dirty,
    bool? touched,
    ...
    return CapybaDayXxiiiTextFieldControllerState(
